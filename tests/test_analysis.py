...
def test_task_round_trip(tmp_path) -> None:
    task = Task(name="Lighting", artist="Eli", due_date=date(2026, 9, 10), description="Scene lighting")
...
def test_performance_analysis() -> None:
    report = analyze_tasks(
        [
            {"task name": "Lighting", "assigned artist": "Eli", "due date": "2026-09-10", "status": "Completed on 2026-09-12"},
            {"task name": "Lighting", "assigned artist": "Eli", "due date": "2026-09-14", "status": "In Progress"},
            {"task name": "Render", "assigned artist": "A", "due date": "2026-09-10", "status": "Completed on 2026-09-09"},
        ]
    )
