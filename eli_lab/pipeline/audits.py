    ...
    if blender:
        ...
        for reference in references:
            if reference.status == "missing":
                ...
                resource = root_path / reference.resource if not reference.resource.is_absolute() else reference.resource
                try:
        ...
        findings.append(AuditFinding("blender_inspection", "info", ".", "Blender was not found on PATH; authoritative .blend inspection was skipped."))
